...
import type * as apiKeys from "../apiKeys.ts";
import type * as files from "../files.ts";
import type * as messages from "../messages.ts";
import type * as streams from "../streams.ts";
import type * as threads from "../threads.ts";
import type * as users from "../users.ts";
import type * as vector_index from "../vector/index.ts";
import type * as vector_tables from "../vector/tables.ts";
