    ...
    <>
      ...
      {showContextPanel && (
        <aside
          ...
          className="fixed right-0 z-40 flex w-80 flex-col border-gray-200/50 border-l bg-white/95 shadow-xl backdrop-blur-md lg:relative lg:z-auto dark:border-gray-700/50 dark:bg-gray-900/95 top-16 bottom-0 pt-6 lg:top-16 lg:pt-6"
        >
